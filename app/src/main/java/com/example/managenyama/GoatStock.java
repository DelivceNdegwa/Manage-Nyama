...
public class GoatStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goat_stock);
        ...
        DocumentReference stockRef = db.collection(stockName).document("Goat");
        //final String[] meat_price = new String[1];

        updateStock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new BottomSheetDialog(GoatStock.this);
                                    ...
                                    stockRef.update("stock_quantity_kg", String.valueOf(finalStock))
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(GoatStock.this, "Stock has been updated", Toast.LENGTH_SHORT).show();
                                                    dialog.dismiss();
                                            ...
                                            .addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(GoatStock.this, "Could not update stock", Toast.LENGTH_SHORT).show();
                                                    Log.d("ERROR:::", e.getMessage());
                                                }
                                            });
                                }else{
                                    Toast.makeText(GoatStock.this, "Stock could not be updated", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                    ...
                    public void onClick(View v) {
                        ...
                        stockRef.update("stock_price_ksh", priceUpdated)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(GoatStock.this, "Cost has been updated", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(GoatStock.this, "Could not update cost", Toast.LENGTH_SHORT).show();
                                        Log.d("ERROR:::", e.getMessage());
                                    }
                                });
                    }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(snapshot.exists()){
                        ...
                        Toast.makeText(GoatStock.this, "Invalid Request", Toast.LENGTH_SHORT).show();
                        Log.d("SNAPSHOT:::", "Does Not Exist");
                    }

                }
                else{
                    Toast.makeText(GoatStock.this, "Unfortunately Stock data could not be fetched", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
