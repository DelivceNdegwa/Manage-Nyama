...
public class BeefStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beef_stock);
        ...
        DocumentReference stockRef = db.collection(stockName).document("Beef");


        updateStock.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new BottomSheetDialog(BeefStock.this);
                                    ...
                                    stockRef.update("stock_quantity_kg", String.valueOf(finalStock))
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(BeefStock.this, "Stock has been updated", Toast.LENGTH_SHORT).show();
                                                    dialog.dismiss();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(BeefStock.this, "Could not update stock", Toast.LENGTH_SHORT).show();
                                                    Log.d("ERROR:::", e.getMessage());
                                                }
                                            });
                                }else{
                                    Toast.makeText(BeefStock.this, "Stock could not be updated", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
                    ...
                    public void onClick(View v) {
                        ...
                        stockRef.update("stock_price_ksh", priceUpdated)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(BeefStock.this, "Cost has been updated", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(BeefStock.this, "Could not update cost", Toast.LENGTH_SHORT).show();
                                        Log.d("ERROR:::", e.getMessage());
                                    }
                                });
                    }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(snapshot.exists()){
                        ...
                        Toast.makeText(BeefStock.this, "Invalid Request", Toast.LENGTH_SHORT).show();
                        Log.d("SNAPSHOT:::", "Does Not Exist");
                    }

                }
                else{
                    Toast.makeText(BeefStock.this, "Unfortunately Stock data could not be fetched", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
