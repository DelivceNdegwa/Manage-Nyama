...
public class PigStock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pig_stock);
                                    ...
                                    stockRef.update("stock_quantity_kg", String.valueOf(finalStock))
                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                ...
                                                public void onSuccess(Void unused) {
                                                    Toast.makeText(PigStock.this, "Stock has been updated", Toast.LENGTH_SHORT).show();
                                                    dialog.dismiss();
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(PigStock.this, "Could not update stock", Toast.LENGTH_SHORT).show();
                                                    Log.d("ERROR:::", e.getMessage());
                                                }
                                            });
                                }else{
                                    Toast.makeText(PigStock.this, "Stock could not be updated", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
        ...
        updatePrice.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                confirmation = dialog.findViewById(R.id.update_stock);
                    ...
                    public void onClick(View v) {
                        ...
                        stockRef.update("stock_price_ksh", priceUpdated)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(PigStock.this, "Cost has been updated", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(PigStock.this, "Could not update cost", Toast.LENGTH_SHORT).show();
                                        Log.d("ERROR:::", e.getMessage());
                                    }
                                });
                    }
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(snapshot.exists()){
                        ...
                        Toast.makeText(PigStock.this, "Invalid Request", Toast.LENGTH_SHORT).show();
                        Log.d("SNAPSHOT:::", "Does Not Exist");
                    }

                }
                else{
                    Toast.makeText(PigStock.this, "Unfortunately Stock data could not be fetched", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
